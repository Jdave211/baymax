...
struct BlueCursorView: View {
    ...
    private let fullWelcomeMessage = "hey! i'm baymac"
        ...
        ZStack {
            ...
            if isCursorOnThisScreen && showWelcome && !welcomeText.isEmpty {
                Text(welcomeText)
                    ...
                    .foregroundColor(companionManager.selectedCharacter.textColor)
                    .padding(.horizontal, 8)
                    .padding(.vertical, 4)
                    .background(
                        RoundedRectangle(cornerRadius: 6, style: .continuous)
                            .fill(companionManager.selectedCharacter.color)
                            .shadow(color: companionManager.selectedCharacter.color.opacity(0.5), radius: 6, x: 0, y: 0)
                    )
                    .fixedSize()
                    .overlay(
                ...
                Text(navigationBubbleText)
                    ...
                    .background(
                        RoundedRectangle(cornerRadius: 6, style: .continuous)
                            .fill(companionManager.selectedCharacter.color)
                            .shadow(
                                color: companionManager.selectedCharacter.color.opacity(0.5 + (1.0 - navigationBubbleScale) * 1.0),
            ...
            Triangle()
                ...
                .shadow(color: companionManager.selectedCharacter.color, radius: 8 + (buddyFlightScale - 1.0) * 20, x: 0, y: 0)
            ...
            BlueCursorWaveformView(audioPowerLevel: companionManager.currentAudioPowerLevel, color: companionManager.selectedCharacter.color)
            ...
            BlueCursorSpinnerView(color: companionManager.selectedCharacter.color)
